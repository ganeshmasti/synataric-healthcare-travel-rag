...
CSV_FILES = {
    ...
    "raw/costs/india_procedure_costs.csv": [
        ["procedure", "city", "low_estimate_inr", "high_estimate_inr", "low_estimate_usd", "high_estimate_usd", "cost_notes"],
        ["Cataract surgery", "Bangalore", "45000", "150000", "540", "1800", "Lens choice, diagnostics, surgeon fee, and facility type affect pricing"],
        ["Knee replacement", "Bangalore", "220000", "650000", "2650", "7800", "Implant choice, room category, hospital stay, and physiotherapy affect pricing"],
        ["Cardiac bypass surgery", "Bangalore", "350000", "900000", "4200", "10800", "ICU stay, graft complexity, tests, and recovery course affect pricing"],
    ],
    "raw/costs/travel_stay_costs.csv": [
        ["item", "city", "low_estimate_inr", "high_estimate_inr", "low_estimate_usd", "high_estimate_usd", "planning_notes"],
        ["Serviced apartment per night", "Bangalore", "2500", "8500", "30", "100", "Accessible rooms and caregiver space may cost more"],
        ["Local medical transport per trip", "Bangalore", "800", "3500", "10", "42", "Wheelchair van or late-night transport may cost more"],
        ["Caregiver daily meals and local travel", "Bangalore", "1200", "3000", "14", "36", "Varies by location and length of stay"],
        ["Airport transfer", "Bangalore", "1800", "6000", "22", "72", "Distance, vehicle type, and mobility needs affect cost"],
    ],
