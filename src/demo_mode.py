...
def render_future_product_vision() -> None:
    st.components.v1.html(
        ...
        *{box-sizing:border-box} body{margin:0;background:#eef4fb;color:#10213d;font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;display:flex;flex-direction:column}
        ...
        .revenue-head{padding:20px 28px;border-bottom:1px solid #d8e3ef;background:#f1f6fc}.head-row{display:flex;justify-content:space-between;gap:20px}.revenue-head h2,.journey-head h2{font-size:20px;margin:0 0 7px}.revenue-head p{margin:0;color:#7892b3;line-height:1.55}.journey-head p{margin:0;color:#91a8c5;line-height:1.55}.revenue .tag{border-color:#ffd18a;background:#fff7e9;color:#a95600}.kpis{display:grid;grid-template-columns:repeat(4,1fr)}.kpi{min-height:190px;padding:24px 28px;border-right:1px solid #e1e8f0;background:white}.kpi:last-child{border-right:0}.kpi .icon{margin:0 0 13px}.kpi strong{display:block;font-size:29px}.kpi b{display:block;margin-top:3px}.kpi small{display:block;margin-top:9px;color:#96aac5;font:700 12px ui-monospace,monospace;line-height:1.6}.kpi:nth-child(2) .icon{border-color:#86e5ee;background:#ebfdff;color:#078ba9}.kpi:nth-child(3) .icon{border-color:#8cebc3;background:#ecfdf5;color:#079669}.kpi:nth-child(4) .icon{border-color:#c8d7e8;background:#f7faff;color:#516b8d}
        .streams{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #e1e8f0}.stream{min-height:350px;padding:25px 28px;border-right:1px solid #e1e8f0}.stream:last-child{border:0}.stream h3{display:flex;align-items:center;margin:10px 0 18px;font-size:17px}.icon{display:inline-grid;place-items:center;width:40px;height:40px;margin-right:10px;border:1px solid #9bc7ff;border-radius:12px;background:#eef6ff;color:#0874b9;font-weight:900}.stream:nth-child(2) .icon{border-color:#8cebc3;background:#ecfdf5;color:#079669}.stream:nth-child(3) .icon{border-color:#d8c8ff;background:#f5f1ff;color:#7030db}.phase{display:inline-block;padding:5px 11px;border:1px solid #a9d0ff;border-radius:999px;background:#edf6ff;color:#0874b9;font:800 11px ui-monospace,monospace}.stream:nth-child(2) .phase{border-color:#8ce8be;background:#ecfcf4;color:#079669}.stream:nth-child(3) .phase{border-color:#d8c8ff;background:#f5f1ff;color:#7030db}.stream ul{margin:0;padding-left:20px;line-height:1.55}.stream li{margin:9px 0;padding-left:2px}.stream li::marker{color:#1476ad}.stream:nth-child(2) li::marker{color:#079669}.stream:nth-child(3) li::marker{color:#7030db}.milestone{margin-top:25px;padding:16px;border:1px solid #a9d0ff;border-radius:12px;background:#edf6ff;font:800 12px ui-monospace,monospace}.scale{display:flex;gap:18px;margin:0 28px 22px;padding:16px 20px;border:1px solid #d8e3ef;border-radius:14px;background:#f7faff;color:#4f7098;line-height:1.55}.scale .icon{flex:0 0 auto;width:28px;height:28px;margin:0;border:0;border-radius:8px}.scale b{display:block;margin-bottom:5px;color:#0874b9;font:800 12px ui-monospace,monospace;letter-spacing:.04em}.scale strong{color:#10213d}
        ...
        <section class="panel revenue">
          <div class="revenue-head"><div class="head-row"><div><h2>Business Model: Aligned With the Patient</h2><p>Start with one paid care journey. Expand after demand and savings are confirmed.</p></div><span class="tag">✧ Business-model hypothesis</span></div></div>
          <div class="kpis"><div class="kpi"><span class="icon">✓</span><strong>$199–$499</strong><b>Navigation Plan</b><small>Pricing hypothesis</small></div><div class="kpi"><span class="icon">♙</span><strong>$1,000–$2,000</strong><b>Human Coordination</b><small>Optional support tier</small></div><div class="kpi"><span class="icon">▥</span><strong>Per Episode</strong><b>Employer / Payer</b><small>After savings confirmation</small></div><div class="kpi"><span class="icon">♢</span><strong>No Pay-to-Rank</strong><b>Patient Aligned</b><small>No identifiable data sales</small></div></div>
          <div class="streams"><div class="stream"><span class="phase">Now</span><h3><span class="icon">✓</span>Patient Journey Fee</h3><ul><li>Treatment-quote analysis</li><li>Local-versus-travel comparison</li><li>Total journey-cost estimate</li><li>Provider-ready navigation plan</li></ul><div class="milestone">First milestone: 20 paid cases</div></div><div class="stream"><span class="phase">Next</span><h3><span class="icon">▥</span>Employer and Payer Episodes</h3><ul><li>Per completed care episode</li><li>Share of independently verified savings</li><li>Employer or health-plan pilot</li><li>Pricing set after real outcome data</li></ul></div><div class="stream"><span class="phase">Later</span><h3><span class="icon">⌘</span>Partner Infrastructure</h3><ul><li>Fixed workflow and integration fees</li><li>Provider quote and intake workflows</li><li>Records, eligibility, scheduling, and travel connectors</li><li>Human approval before every write action</li><li>Payment never influences ranking</li></ul></div></div>
          <div class="scale"><span class="icon">▥</span><div><b>ILLUSTRATIVE SCALE — NOT A FORECAST</b>At $500–$1,000 in blended net revenue per completed care journey, 10,000 annual journeys would produce <strong>$5–$10 million</strong> in revenue; 100,000 journeys would produce <strong>$50–$100 million.</strong></div></div>
        </section>
        <section class="panel"><div class="journey-head"><div class="head-row"><div><h2>Synataric Patient Journey: Seamless Care, Global Access</h2><p>Experience the future of medical tourism — AI-guided, end-to-end, personalized.</p></div><span class="tag">✧ Vision scenario</span></div></div><div class="journey-body"><div class="steps"><div><div class="step"><h3>◉ AI-Powered Care Planning</h3><small>STEP 01</small><ul><li>Patient shares their care goal and constraints.</li><li>Synataric organizes evidence, options, costs, and next steps.</li></ul><em>Helping patients navigate care with clarity.</em></div><div class="comparison"><div><small>US OPTION</small><b>$113,000</b><span>6-month wait</span></div><div><small>GLOBAL OPTION</small><b>$10,000</b><span>2-week availability</span></div></div><div class="saving">↘ Potential saving: $103,000</div></div><div class="step"><h3>✈ Automated Logistics &amp; Coordination</h3><small>STEP 02</small><ul><li>Automatically files visa applications</li><li>Books optimal flights and accommodation</li><li>Securely transfers medical records</li><li>Schedules pre-operative virtual consultations</li></ul><em>Executed seamlessly — with human approval for consequential actions.</em></div><div><div class="step"><h3>♡ AI-Monitored Recovery &amp; Savings</h3><small>STEP 03</small><ul><li>AI-monitored recovery protocols</li><li>Scheduled virtual follow-ups</li><li>Proactive continuous-care coordination</li></ul><em>Demonstrating the potential value and efficiency of Synataric Global.</em></div><div class="outcome">FINAL OUTCOME<strong>$103,000</strong>Potential patient savings</div></div></div></div></section>
        """,
        height=1650,
        scrolling=False,
    )
